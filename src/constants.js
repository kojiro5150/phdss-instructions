...
export const AI_PROCUREMENT_KEYWORDS = [
...
export const ECONOMICS_KEYWORDS = [
...
export const ANALYSIS_MODES = ["CORE","FULL","CHAIR_SPECIFIED"];

export const MANDATORY_DIRECTOR_IDS = ["systems","safety"];
